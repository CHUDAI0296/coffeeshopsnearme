...
export default function DessertShopsPage() {
  const desserts = shops.filter((shop: Shop) => shop.type === 'dessert');
  return (
    <main className="max-w-7xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-6">Dessert Shops in San Jose</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {desserts.map((shop: Shop) => (
          <div
            key={shop.slug}
